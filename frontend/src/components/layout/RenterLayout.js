/*
Renter layout component.
Provides a shared sidebar and page container for all renter pages.
*/
...
export default function RenterLayout() {
    ...
    useEffect(() => {
        async function loadUnreadNotificationsCount() {
            ...
            try {
                const result = await getUnreadNotificationCount(renterId);
                ...
                >
                    ...
                    <nav className="flex-1 px-4 py-6">
                        <div className="space-y-2">
                            <button
                                type="button"
                                onClick={() => handleNavigate("/renter")}
                                className={getNavButtonClass("apartments")}
                            >
                            ...
                            <button
                                type="button"
                                onClick={() => handleNavigate("/renter/issues")}
                            ...
                            <button
                                type="button"
                                onClick={() => handleNavigate("/renter/notifications")}
                            ...
                            <button
                                type="button"
                                onClick={() => handleNavigate("/renter/settings")}
